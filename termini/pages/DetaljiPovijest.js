...
export default function Complete({navigation}) {
    ...
    justifyContent:"center"}}>
        <TouchableOpacity onPress={()=>{navigation.navigate("Povijest");dispatch(NEW())}}>
        ...
        <View style={styles.naslov}><Text style={{fontSize:20 ,color:theme=="light"?"black":"white",fontWeight:theme=="light"?"":"bold"}}>{eventInfo.sport}</Text></View>
            ...
            <Text style={{color:theme=="light" ? "black":"white",marginTop:10,fontSize:18,fontWeight:theme=="light"?"":"bold"}}>SUDIONICI</Text>
            <ScrollView style={{maxHeight:"20%",backgroundColor:theme=="light"?"white":"#28559a",width:"80%",marginTop:20,borderColor:"gray",borderWidth:1,borderRadius:5}}>
            ...
            <Text style={{color:theme=="light" ? "black":"white",marginTop:10,fontSize:18,fontWeight:theme=="light"?"":"bold"}}>OPIS</Text>
            <ScrollView style={{maxHeight:"20%",backgroundColor:theme=="light"?"white":"#28559a",width:"80%",marginTop:20,borderColor:"gray",borderWidth:1,borderRadius:5}}>
