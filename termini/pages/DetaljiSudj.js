...
export default function Complete({navigation}) {
    ...
    justifyContent:"center"}}>
        <TouchableOpacity onPress={()=>{navigation.navigate("AktivniTermini");dispatch(NEWSudjiOrd())}}>
         ...
         <View style={styles.naslov}><Text style={{fontSize:20 ,color:theme=="light"?"black":"white",fontWeight:theme=="light"?"":"bold",textTransform:"uppercase"}}>{eventInfo.grad}</Text></View>
        <View style={styles.naslov}><Text style={{fontSize:20 ,color:theme=="light"?"black":"white",fontWeight:theme=="light"?"":"bold"}}>{eventInfo.sport}</Text></View>
            ...
            <ScrollView style={{maxHeight:"20%",backgroundColor:theme=="light"?"white":"#28559a",width:"80%",marginTop:"2%",borderColor:"gray",borderWidth:1,borderRadius:5}}>
            <View style={styles.opis}><Text style={{color:theme=="light" ? "black":"white"}}>{eventInfo.opis}</Text></View>
            </ScrollView>
            
            <TouchableOpacity onPress={()=>gumb()} style={{backgroundColor:theme=="light"?"white" : "#3778c2",marginTop:"3%",width:Dimensions.get("window").width/1.4,alignItems:"center",justifyContent:"center",padding:10,borderRadius:5}}>
